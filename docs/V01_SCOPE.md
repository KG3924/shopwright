...
- Shop drawings compiled from the parts read off the photos — face / edge / end tickets at those inches, not a stock silhouette
...
- CAD / DXF / CNC G-code export
- Sheet-goods nesting that rivals CutList Plus
- Perfect clones of a commercial SKU
- Accounts, cloud save, sharing a packet as a link
- Video technique lessons
- Live inventory / prices from Home Depot
- Arbitrary ZIP → every hardwood dealer in America

Next cuts that would matter:

1. Sheet-goods nesting
2. More templates (bed, desk, workbench, outdoor table)
3. Shop inventory (“I don’t have a table saw”) rewriting the route automatically
4. True measured drawings from a labeled blueprint scan
