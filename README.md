...
- **Shop drawings** — compiled from the boards we read in the photos: front / side / plan (photo outline over the blanks), exploded assembly, and a face-edge-end ticket for every part. Curves (saddle seats, splay, hoop backs) are traced, not boxed.
