...
- **Shop drawings** — compiled from the boards we read in the photos: front / side / plan (photo outline or blanks, not both), exploded assembly of lettered cut-list blanks pulled apart, and a face-edge-end ticket for every part. Curves (saddle seats, splay, hoop backs) live on the elevations.
